local nord = {
	--16 colors
	black = "#21252E", -- nord0 in palette
	dark_gray = "#2C313D", -- nord1 in palette
	gray = "#353C4A", -- nord2 in palette
	...
	glacier = "#7EAEDE", -- nord9 in palette
	blue = "#6E9CD4", -- nord10 in palette
